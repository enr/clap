...
public class Casts {
    ...
    /**
     * ritorna x chiave specificata, oggetto della classe passata Returns, for
     * the specified key, an object casted to the required class, or throws an
     * IllegalArgumentException. Useful for raw maps.
     * 
     */
    @SuppressWarnings("unchecked")
